...
//#include <GxGDEW042T2_BK/GxGDEW042T2_BK.cpp>      // 4.2" b/w //#include <GxGDEW042T2_FPU/GxGDEW042T2_FPU.cpp>      // 4.2" b/w
...
//GxGDEW0154Z04 display1(io1, -1, 4); // RST  disabled, BUSY = D2(4)
...
void loop()
{
  ...
  //Serial.println("GxGDEW0154Z04::showBitmapExample(display1)");
  //BMxGDEW0154Z04::showBitmapExample(display1);
